...
CREATE TABLE IF NOT EXISTS EcritPar (
  ...
  FOREIGN KEY (Prenom, Nom, Numero) REFERENCES Auteur(Prenom, Nom, Numero)ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY (OID) REFERENCES Oeuvre(ID) ON DELETE CASCADE)
  CHARACTER SET latin1 COLLATE latin1_bin
  ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS Film (
  ...
  PRIMARY KEY (FilmID),
  FOREIGN KEY (FilmID) REFERENCES Oeuvre(ID) ON DELETE CASCADE)
  CHARACTER SET latin1 COLLATE latin1_bin
  ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS Serie (
  ...
  AnneeFin INT,
  PRIMARY KEY (SerieID),
  FOREIGN KEY (SerieID) REFERENCES Oeuvre(ID) ON DELETE CASCADE)
  CHARACTER SET latin1 COLLATE latin1_bin
  ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS Episode (
  ...
  FOREIGN KEY (EpisodeID) REFERENCES Oeuvre(ID) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS Pays (
  ...
  PRIMARY KEY (ID, Pays),
  FOREIGN KEY (ID) REFERENCES Oeuvre(ID) ON DELETE CASCADE)
  CHARACTER SET latin1 COLLATE latin1_bin
  ENGINE = InnoDB;
