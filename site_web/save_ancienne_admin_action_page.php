...
<section id="op_on_film">
    <div class="container text-center">
        ...
        <form action="/action_administrator.php" method="post">
            ...
            <div class="form-group text-center">
                <input type="text_field" class="form-control" name="rating_note_film"
                       placeholder="Enter a rating note (optional)">
            </div>
            <div class="col-lg-12 text-center">
...
<section id="op_on_serie">
    <div class="container text-center">
        ...
        <form action="/action_administrator.php" method="post">
            ...
            <div class="form-group text-center">
                <input type="text_field" class="form-control" name="begin_year" placeholder="Enter the begin year"
                       required>
            </div>
            <div class="form-group text-center">
                <input type="text_field" class="form-control" name="genre_serie"
                       placeholder="Enter the genre (optional)">
            </div>
            <div class="form-group text-center">
                <input type="text_field" class="form-control" name="end_year"
                       placeholder="Enter the end year (optional)">
            </div>
            <div class="form-group text-center">
                <input type="text_field" class="form-control" name="rating_note_serie"
                       placeholder="Enter a rating note(optional)">
            </div>
            <div class="col-lg-12 text-center">
...
<section id="op_on_dir">
    <div class="container text-center">
        ...
        <form action="/action_administrator.php" method="post">
            <div class="form-group text-center">
                <input type="text_field" class="form-control" name="director_firstname"
                       placeholder="Enter the FirstName" required>
            </div>
            <div class="form-group text-center">
                <input type="text_field" class="form-control" name="director_secondname"
                       placeholder="Enter the SecondName" required>
            </div>
            <div class="form-group text-center">
                <input type="text_field" class="form-control" name="gender"
                       placeholder="Enter the gender (optional if person already exist)">
            </div>
            <div class="col-lg-12 text-center">
...
<section id="op_on_writer">
    <div class="container text-center">
        ...
        <form action="/action_administrator.php" method="post">
            <div class="form-group text-center">
                <input type="text_field" class="form-control" name="writer_firstname" placeholder="Enter the FirstName"
                       required>
            </div>
            <div class="form-group text-center">
                <input type="text_field" class="form-control" name="writer_secondname"
                       placeholder="Enter the SecondName" required>
            </div>
            <div class="form-group text-center">
                <input type="text_field" class="form-control" name="gender"
...
<section id="op_on_actor">
    <div class="container text-center">
        ...
        <form action="/action_administrator.php" method="post">
            <div class="form-group text-center">
                <input type="text_field" class="form-control" name="actor_firstname" placeholder="Enter the FirstName"
                       required>
            </div>
            <div class="form-group text-center">
                <input type="text_field" class="form-control" name="actor_secondname" placeholder="Enter the SecondName"
                       required>
            </div>
            <div class="form-group text-center">
                <input type="text_field" class="form-control" name="gender"
