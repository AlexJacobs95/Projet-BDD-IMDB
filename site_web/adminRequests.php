...
/*
$insertion_query= "INSERT INTO Personne(Nom, Prenom, Numero)
VALUE ('$nom', '$prenom', '$numero')";*/
...
IF A PAS DANS PERSONNE:
ETES VOUS SUR DE VOULOIR LE RAJOUTER A LA DATABASE
IF OUI
AJOUT DE A DANS PERSONNE ACTEUR ET ROLE
IF NON
BYE
ELSE
PROPOSER LES PERSONNES QUI S APPELLENT DEJA A
IF A PAS DANS PROPOSITON
RAJOUT DE A DANS PERSONNE ACTEUR ET ROLE
ELSE
SELECTION D UNE PROPOSITON
IF A PAS DANS ACTEUR
AJOUT DE A DANS ACTEUR ET ROLE
ELSE
AJOUT DE A DANS ROLE
*/
